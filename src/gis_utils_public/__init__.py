...
Open GIS utilities and lazy ArcGIS utility namespace.
...
#         - Example import: "from gis_utils_public import hello"
#
...
# Public API
__all__ = ["__version__", "hello", "arcgis_utils", "read_yml_config"]
